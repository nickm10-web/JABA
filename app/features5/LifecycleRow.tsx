...
const STAGES: Array<{ topLabel: string; bottomLabel: string; iconSrc?: string; Icon?: StageIcon }> = [
  { topLabel: "PITCH", bottomLabel: "Brand Deals", iconSrc: "/school-logos/icon_find.png" },
  { topLabel: "BUILD", bottomLabel: "Campaigns", Icon: LaunchArrowIcon },
  { topLabel: "MANAGE", bottomLabel: "Deliverables", Icon: ClipboardIcon },
  { topLabel: "TRACK", bottomLabel: "Execution", iconSrc: "/school-logos/icon_report.png" },
  { topLabel: "SHOWCASE ROI", bottomLabel: "Performance", iconSrc: "/school-logos/icon_benchmark.png" },
];
...
export default function LifecycleRow() {
  ...
  return (
    ...
    >
      <ol className="hidden md:flex items-center justify-center gap-2" aria-label="Pitch to Showcase ROI lifecycle flow">
      ...
      <div className="md:hidden" aria-label="Pitch to Showcase ROI lifecycle flow">
