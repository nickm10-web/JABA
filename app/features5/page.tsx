...
const SCROLL_TASKS = [
  { icon: "📸", label: "Instagram Post Due for Nike", sub: "Due Sep 18", statusColor: "#C8FF00" },
  { icon: "🎵", label: "TikTok Video Due for Vuori", sub: "Due Sep 19", statusColor: "#C8FF00" },
  { icon: "💰", label: "Adidas Payment Received", sub: "$8,500 deposited", statusColor: "#C8FF00" },
  { icon: "📧", label: "New Brand Inquiry from Celsius", sub: "Received Sep 14", statusColor: "#a78bfa" },
  { icon: "📄", label: "Contract Ready to Sign", sub: "Fabletics deal", statusColor: "#C8FF00" },
  { icon: "✅", label: "Campaign Brief Approved", sub: "Nike approved Sep 17", statusColor: "#C8FF00" },
  { icon: "⚠️", label: "Deliverable Due Tomorrow", sub: "Adidas Reel", statusColor: "#ff6b35" },
  { icon: "📅", label: "Content Shoot Scheduled", sub: "Thursday 2-4pm", statusColor: "#a78bfa" },
];
const IMESSAGE_THREAD = [
  { from: "jaba", text: "Your Nike Instagram Story is due tomorrow at 9am. Want me to prep the caption and hashtags?", time: "9:14 AM" },
  { from: "agent", text: "Yeah do it", time: "9:15 AM" },
  { from: "jaba", text: "Done. Caption and tags are ready for review in your dashboard. I set a reminder for tonight so you don't forget.", time: "9:15 AM" },
  { from: "jaba", text: "Heads up. Vuori wants to work with you. 73% audience overlap with their target demo. Want me to pull their offer details?", time: "9:17 AM" },
  { from: "agent", text: "Yeah send it", time: "9:18 AM" },
  { from: "jaba", text: "Done. Vuori is offering $4,500 for 2 Instagram posts and 1 TikTok. Contract and brief are in your deals tab.", time: "9:18 AM" },
  { from: "jaba", text: "Your Adidas payment of $8,500 is 3 days overdue. Want me to send a follow-up to their finance team?", time: "9:31 AM" },
  { from: "agent", text: "Yes", time: "9:32 AM" },
  { from: "jaba", text: "Sent. I will follow up again in 48 hours if they don't respond.", time: "9:32 AM" },
  { from: "jaba", text: "You have 4 of 5 Nike deliverables done. The last one is an Instagram Reel due Friday. Want me to block time on your calendar?", time: "10:05 AM" },
  { from: "agent", text: "Block Thursday afternoon", time: "10:06 AM" },
  { from: "jaba", text: "Done. Thursday 2-4pm blocked for Nike Reel shoot. I will remind you that morning.", time: "10:06 AM" },
  { from: "jaba", text: "Your engagement rate jumped 18% this month. Three new brands viewed your profile this week. Want a breakdown?", time: "11:22 AM" },
  { from: "agent", text: "Send it", time: "11:23 AM" },
  { from: "jaba", text: "Report sent to your inbox. Top brand interest: Fabletics, Celsius, and Therabody.", time: "11:23 AM" },
];
const SCHEDULE_DATA: Record<string, { campaign: string; deliverables: string; tasks: { icon: string; title: string; sub: string }[] }> = {
  Mo: {
    campaign: "Nike Social Campaign",
    deliverables: "4 / 5 deliverables completed",
    tasks: [
      { icon: "📸", title: "Instagram Post Due", sub: "Caption and tags ready for review" },
      { icon: "💬", title: "Brand Waiting on You", sub: "Nike needs creative approval" },
    ],
  },
  Tu: {
    campaign: "Adidas Fall Drop",
    deliverables: "2 / 4 deliverables completed",
    tasks: [
      { icon: "🎵", title: "TikTok Video Due", sub: "Due by 3:00 PM" },
      { icon: "📄", title: "Review Contract Update", sub: "New terms from Adidas" },
    ],
  },
  We: {
    campaign: "Vuori Partnership",
    deliverables: "1 / 3 deliverables completed",
    tasks: [
      { icon: "📸", title: "Lifestyle Photo Shoot", sub: "Asset due to brand by EOD" },
      { icon: "📧", title: "Respond to Vuori Brief", sub: "Brief received yesterday" },
    ],
  },
  Th: {
    campaign: "Nike Social Campaign",
    ...
    tasks: [
      { icon: "✅", title: "Campaign Complete", sub: "Performance report ready" },
      { icon: "💰", title: "Payment Submitted", sub: "$8,500 invoice sent" },
    ],
  },
  Fr: {
    campaign: "Fabletics NIL Deal",
    deliverables: "3 / 5 deliverables completed",
    tasks: [
      { icon: "⚠️", title: "Instagram Story Overdue", sub: "Was due Wednesday" },
      { icon: "📅", title: "Shoot Rescheduled", sub: "Next Monday 10AM" },
    ],
  },
  Sa: {
    campaign: "Alo Yoga Partnership",
    deliverables: "2 / 2 deliverables completed",
    tasks: [
      { icon: "📊", title: "Performance Report Ready", sub: "ER 4.2%, above benchmark" },
      { icon: "🤝", title: "Renewal Opportunity", sub: "Brand wants to extend" },
    ],
  },
  Su: {
    campaign: "Nike Social Campaign",
    deliverables: "4 / 5 deliverables completed",
    tasks: [
      { icon: "📸", title: "Instagram Post Due", sub: "Caption and tags ready" },
      { icon: "💬", title: "Brand Waiting on You", sub: "Nike needs creative approval" },
    ],
  },
};
...
const LIFECYCLE_STEPS = [
  { icon: "🤝", label: "Find brand deals" },
  { icon: "📋", label: "Manage campaigns" },
  { icon: "✅", label: "Track your\\ndeliverables" },
  { icon: "🧾", label: "Get paid\\non time" },
  { icon: "📈", label: "Prove your value" },
];
// ─── SVG neon icons ───────────────────────────────────────────────────────────
  ...
  return (
    <div className="bg-zinc-900 rounded-2xl border border-white/10 overflow-hidden">
      ...
      <div className="px-4 pt-4 pb-3 border-b border-white/10">
        <p className="text-white font-semibold text-sm">Your Week at a Glance</p>
        <p className="text-white/40 text-xs mt-0.5">Active deals, deliverables, and deadlines</p>
      </div>
      {/* Active campaign row */}
      <div className="mx-3 mt-3 bg-zinc-800 rounded-xl p-3">
        <div className="flex items-center gap-2 mb-2">
          <span className="text-yellow-400 text-xs">⚡</span>
          <span className="text-white/50 text-xs uppercase tracking-wider">Active Deals :</span>
        </div>
        <div
    ...
    <>
      ...
      >
        ...
        <FadeUp delay={250} className="relative z-10">
          <p className="text-white/60 text-lg md:text-xl mt-6 max-w-md mx-auto">
            So athletes can focus on what matters.
          </p>
        </FadeUp>
      ...
      <section className="relative z-10 py-6 overflow-hidden bg-black">
        <FadeUp>
          <p className="text-center text-sm text-white/50 mb-6 tracking-wide">
            Trusted by athletes across college and pro sports
          </p>
        </FadeUp>
        <div
        ...
        <div className="max-w-5xl mx-auto grid md:grid-cols-2 gap-10 items-center">
          ...
          <FadeRight className="md:col-start-1 md:row-start-1">
            ...
            <h3 className="text-3xl md:text-4xl font-bold font-bricolage text-white mb-4 leading-tight">
              JABA Sits in Your <span className="text-[#C8FF00]">Group Chat.</span>
            </h3>
            <p className="text-white/60 mb-6">
              Deadlines, brand comms, reminders, deliverables. JABA handles the back and forth so you can stay focused on your sport.
            </p>
          </FadeRight>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
              <div className="order-1 md:order-2">
                ...
                <h2 className="font-bricolage text-3xl md:text-4xl font-bold leading-tight text-white mb-4">
                  See Who Wants to <span className="text-[#C8FF00]">Work With You.</span>
                </h2>
                <p className="text-white/60 text-lg mb-6">
                  JABA has over 300K brand deals in its database. Know what brands are working with which athletes, who to reach out to, and where the opportunities are for you.
                </p>
              </div>
        ...
        <div className="max-w-5xl mx-auto px-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
            <div className="order-1 md:order-1">
              <span className="inline-block text-xs text-white/70 border border-white/20 rounded-full px-3 py-1 mb-4">Deal Management</span>
              <h2 className="font-bricolage text-3xl md:text-4xl font-bold leading-tight text-white mb-4">
                Every Deal. <span className="text-[#C8FF00]">One Place.</span>
              </h2>
              <p className="text-white/60 text-lg mb-6">
                JABA generates AI media kits, handles outreach, and keeps every contract, payment, and deliverable organized in one dashboard.
              </p>
            </div>
      ...
      <section className="relative z-10 py-16 bg-black">
        ...
        <div className="max-w-5xl mx-auto px-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
            <div className="order-1 md:order-2">
              <span className="inline-block text-xs text-white/70 border border-white/20 rounded-full px-3 py-1 mb-4">Athlete Intelligence</span>
              <h2 className="font-bricolage text-3xl md:text-4xl font-bold leading-tight text-white mb-4">
                Know Your <span className="text-[#C8FF00]">Worth.</span>
              </h2>
              <p className="text-white/60 text-lg mb-6">
                See your real metrics, engagement trends, and how you compare to athletes in your space. Walk into every negotiation with the data to back it up.
              </p>
              <div className="mt-6 flex items-center gap-3 rounded-full border border-white/15 bg-white/[0.06] px-5 py-3 text-sm max-w-sm backdrop-blur-sm hover:border-[#C8FF00]/40 hover:bg-white/[0.09] transition-all duration-300 cursor-default">
                ...
                <span className="text-white/50 font-normal tracking-wide">&quot;How do my numbers compare?&quot;</span>
              </div>
            </div>
        ...
        <div className="max-w-5xl mx-auto px-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
            <div className="order-1 md:order-1">
              ...
              <h2 className="font-bricolage text-3xl md:text-4xl font-bold leading-tight text-white mb-4">
                See What Content <span className="text-[#C8FF00]">Actually Works.</span>
              </h2>
              <p className="text-white/60 text-lg mb-6">
                JABA analyzes over 1M posts to show you what formats, hooks, and timing drive the best results. Post smarter, not more.
              </p>
              <div className="mt-6 flex items-center gap-3 rounded-full border border-white/15 bg-white/[0.06] px-5 py-3 text-sm max-w-md backdrop-blur-sm hover:border-[#C8FF00]/40 hover:bg-white/[0.09] transition-all duration-300 cursor-default">
                ...
                <span className="text-white/50 font-normal tracking-wide">&quot;What type of content gets the most engagement?&quot;</span>
              </div>
            </div>
            <div className="order-2 md:order-2">
              <div className="relative w-full max-w-[520px] mx-auto lg:mx-0 aspect-square overflow-hidden rounded-2xl border border-white/10 bg-zinc-900 shadow-[0_20px_50px_rgba(0,0,0,0.5)]">
      ...
      <section className="relative z-10 py-20 px-6 bg-black">
        ...
        <div className="grid md:grid-cols-2 gap-10 items-center">
          ...
          <FadeLeft className="md:col-start-1 md:row-start-1">
            ...
            <h3 className="text-3xl md:text-4xl font-bold font-bricolage text-white mb-4 leading-tight">
              Focus on Your Sport. <span className="text-[#C8FF00]">JABA Handles the Rest.</span>
            </h3>
            <p className="text-white/60 mb-6">
              Your influence is valuable. JABA makes sure you never leave money on the table or miss an opportunity.
            </p>
