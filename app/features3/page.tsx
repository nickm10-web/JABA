...
export default function Agency2Page() {
  const [showInActionVideo, setShowInActionVideo] = useState(false);
            ...
            <ScaleIn>
              ...
              >
                ...
                <div className="rounded-[34px] overflow-hidden aspect-[9/16]">
                  {showInActionVideo ? (
                    <iframe
                      src="https://www.youtube.com/embed/0BCwKKac75Q?autoplay=1&loop=1&playlist=0BCwKKac75Q&rel=0&modestbranding=1&controls=1"
                      width="100%"
                      height="100%"
                      style={{ border: "none" }}
                    ...
                    <button
                      ...
                      onClick={() => setShowInActionVideo(true)}
                    >
                      <Image
                        src="/jaba-in-action.png"
                        alt="JABA in action video thumbnail"
                        fill
                        className="object-cover"
                        priority
                      />
                      <span className="absolute inset-0 bg-black/15" />
                      <span className="absolute inset-0 flex items-center justify-center translate-y-3">
      ...
      <section className="relative z-10 py-24 px-6 text-center bg-black">
        ...
        <FadeUp delay={200}>
          <p className="mt-6 text-lg text-white/75 max-w-2xl mx-auto">
            Agencies are now managing hundreds of deliverables across their athlete roster - and all the approvals, follow-ups, payments, and reporting tied to execution.
          </p>
          <p className="mt-3 text-lg font-semibold text-white/80">Right now, this is all manual work.</p>
        </FadeUp>
      </section>
      ...
      <section className="relative z-10 py-20 px-6 bg-black">
        ...
        <div className="max-w-5xl mx-auto grid md:grid-cols-2 gap-10 items-center">
          ...
          <FadeLeft className="md:col-start-1 md:row-start-1">
            ...
            <h3 className="text-3xl md:text-4xl font-bold font-bricolage text-white mb-4 leading-tight">
              We&apos;re Making it Easy for Everyone to Work <span className="text-[#C8FF00]">With Athletes.</span>
            </h3>
            <p className="text-white/60 mb-6">
