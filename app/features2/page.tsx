...
import PlayflyCrmOutreachSection from "./PlayflyCrmOutreachSection";
  ...
  return (
    <div className="bg-black min-h-screen text-white overflow-x-hidden" style={{ fontFamily: "var(--font-inter), sans-serif" }}>
      ...
      <main className="relative z-10">
        ...
        <PlayflyCrmOutreachSection />

        <section className="relative z-10 py-20 px-6 bg-black">
          <div className="max-w-5xl mx-auto grid md:grid-cols-2 gap-10 items-center">
            <div className="w-full order-2 md:order-1">
              <div className="mx-auto md:ml-0 md:mr-auto w-full max-w-[340px] rounded-2xl border border-[#C8FF00]/30 bg-[#111] shadow-[0_0_60px_rgba(180,255,0,0.35)] overflow-hidden">
