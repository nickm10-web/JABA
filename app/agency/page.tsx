...
export default function AgencyPage() {
  ...
  return (
    <div className="bg-[#0A0A0A] min-h-screen text-white relative" style={{ fontFamily: "Inter, sans-serif" }}>
        ...
        <div className="max-w-5xl mx-auto text-center">
          ...
          >
            ...
            <h1
              ...
              style={{ fontFamily: "Bebas Neue, sans-serif", fontSize: "clamp(3.5rem, 8vw, 7.5rem)" }}
            >
              AI THAT PROJECT<br />
              MANAGES ATHLETES<br />
      ...
      <section className="py-24 px-8 border-b border-[#1a1a1a]">
        <div className="max-w-6xl mx-auto">
          <Section>
            ...
            <h2 className="text-white leading-none mb-8" style={{ fontFamily: "Bebas Neue, sans-serif", fontSize: "clamp(2.5rem, 5vw, 4.5rem)" }}>
      ...
      <section className="py-24 px-8 border-b border-[#1a1a1a]">
        <div className="max-w-6xl mx-auto">
          <Section>
            ...
            <h2 className="text-white leading-none mb-12" style={{ fontFamily: "Bebas Neue, sans-serif", fontSize: "clamp(2.5rem, 5vw, 4.5rem)" }}>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-0 border border-[#222] mb-4">
              {[
                ...
                <div key={a.name} className={`p-6 ${i < 3 ? "border-r border-[#222]" : ""}`}>
                  ...
                  <div className="text-[#CAFF00] text-lg font-bold mb-3" style={{ fontFamily: "Bebas Neue, sans-serif" }}>{a.score}</div>
                ...
                <div className="grid grid-cols-2 gap-0 border border-[#222]">
                  {[
                    ...
                    <div key={t.topic} className={`p-4 ${i % 2 === 0 ? "border-r border-[#222]" : ""} ${i < 6 ? "border-b border-[#222]" : ""}`}>
                      <div className="text-[#CAFF00] text-sm font-bold mb-0.5" style={{ fontFamily: "Bebas Neue, sans-serif" }}>{t.count}</div>
