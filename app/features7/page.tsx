...
export default function Agency2Page() {
  ...
  return (
    <div className="bg-black min-h-screen text-white overflow-x-hidden max-w-[100vw]" style={{ fontFamily: "var(--font-inter), sans-serif" }}>
      ...
      <main className="relative z-10 overflow-x-hidden">
        ...
        >
          ...
          <Reveal className="relative z-10 [transition-delay:80ms]">
            <h1 className="text-[clamp(1.75rem,8vw,4.5rem)] sm:text-5xl md:text-7xl font-black uppercase leading-none mb-6 font-bricolage text-white mx-auto">
              ATHLETE BRAND
              <br />
              CAMPAIGNS,
              <br />
          ...
          <Reveal className="relative z-10 [transition-delay:180ms]">
            <p className="text-sm sm:text-lg md:text-xl text-white/85 max-w-3xl mx-auto leading-relaxed px-2">
        ...
        >
          ...
          <Reveal>
            <h2 className="text-3xl md:text-5xl font-bold font-bricolage text-white mb-16">JABA manages the <span className="text-[#C8FF00]">whole campaign lifecycle</span> with your talent</h2>
            <LifecycleRow />
          </Reveal>
        </section>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
              <div className="order-2 lg:order-1">
                <div className="relative w-full max-w-[560px] mx-auto lg:mx-0 aspect-[1/1] overflow-hidden rounded-2xl border border-white/10 bg-zinc-900 shadow-[0_20px_50px_rgba(0,0,0,0.5)]">
                  <Image
                    src="/images/agency/brand.png"
                    alt="JABA connecting Brand and Athlete"
                    fill
              ...
              <div className="order-1 lg:order-2">
                <span className="inline-block text-xs text-white/70 border border-white/20 rounded-full px-3 py-1 mb-4">Campaign Concepts</span>
                <h2 className="font-bricolage text-3xl md:text-4xl font-bold leading-tight text-white mb-4">
                  JABA Finds the Overlap Between <span className="text-[#C8FF00]">Talent and Brand.</span>
                </h2>
                <p className="text-white/60 text-base md:text-lg mb-6">
                  JABA analyzes your brand identity and the athlete&apos;s content style to generate campaign concepts that feel authentic to both.
                </p>
                <div className="grid grid-cols-2 gap-3">
                  <div className="rounded-xl border border-white/10 bg-white/[0.03] px-4 py-3">
                    <h4 className="text-xs font-bold text-[#C8FF00] uppercase tracking-wide mb-1">&gt; Campaign Idea</h4>
                    <p className="text-white/55 text-xs leading-relaxed">Personalized concepts built around the athlete&apos;s voice and your brand story.</p>
                  </div>
                  <div className="rounded-xl border border-white/10 bg-white/[0.03] px-4 py-3">
                    <h4 className="text-xs font-bold text-[#C8FF00] uppercase tracking-wide mb-1">&gt; Content Concept</h4>
                    <p className="text-white/55 text-xs leading-relaxed">Behind-the-scenes, day-in-the-life, and product integration formats tailored to the athlete.</p>
                  </div>
                  <div className="rounded-xl border border-white/10 bg-white/[0.03] px-4 py-3">
                    <h4 className="text-xs font-bold text-[#C8FF00] uppercase tracking-wide mb-1">&gt; Caption</h4>
                    <p className="text-white/55 text-xs leading-relaxed">Written in the athlete&apos;s tone with brand messaging woven in naturally.</p>
                  </div>
                  <div className="rounded-xl border border-white/10 bg-white/[0.03] px-4 py-3">
                    <h4 className="text-xs font-bold text-[#C8FF00] uppercase tracking-wide mb-1">&gt; Script Hook</h4>
                    <p className="text-white/55 text-xs leading-relaxed">Attention-grabbing openers matched to the athlete&apos;s storytelling style.</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="max-w-5xl mx-auto grid md:grid-cols-2 gap-10 lg:gap-16 items-center">
            <Reveal className="order-1 md:order-1">
              ...
              <h3 className="text-3xl md:text-4xl font-bold font-bricolage text-white mb-4 leading-tight">
                JABA Handles the Manual Work of <span className="text-[#C8FF00]">Managing a Campaign.</span>
              </h3>
          ...
          <div className="max-w-5xl mx-auto px-6">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
              <div className="order-2 lg:order-first">
                <div className="relative w-full max-w-[560px] mx-auto lg:mx-0 aspect-square overflow-hidden rounded-2xl border border-white/10 bg-zinc-900 shadow-[0_20px_50px_rgba(0,0,0,0.5)]">
                  <Image
                    src="/images/agency/brandintel.png"
                    alt="JABA brand intelligence dashboard"
                    fill
                    className="object-cover"
                    sizes="(max-width: 1024px) 100vw, 560px"
                  />
              ...
              <div className="order-1 lg:order-last">
                <span className="inline-block text-xs text-white/70 border border-white/20 rounded-full px-3 py-1 mb-4">Brand Intelligence</span>
                <h2 className="font-bricolage text-3xl md:text-4xl font-bold leading-tight text-white mb-4">
                  Your Brand. <span className="text-[#C8FF00]">Full Picture.</span>
                </h2>
                <p className="text-white/60 text-base md:text-lg mb-6">
                  JABA gives you a real-time view of how your brand is performing across every platform and what content is actually moving the needle.
                </p>
                <div className="space-y-4 mb-6">
                  <div className="border-t border-white/10 pt-4">
                    <p className="text-xs font-bold text-[#C8FF00] uppercase tracking-wide mb-1">&gt; Platform Performance</p>
                    <p className="text-white/80 text-sm font-semibold">Track reach, impressions, video views, and saves across all connected channels.</p>
                  </div>
                  <div className="border-t border-white/10 pt-4">
                    <p className="text-xs font-bold text-[#C8FF00] uppercase tracking-wide mb-1">&gt; Top Posts</p>
                    <p className="text-white/80 text-sm font-semibold">See which content drives the most engagement and why.</p>
                  </div>
                  <div className="border-t border-white/10 pt-4">
                    <p className="text-xs font-bold text-[#C8FF00] uppercase tracking-wide mb-1">&gt; Trend Analysis</p>
                    <p className="text-white/80 text-sm font-semibold">Identify what&apos;s growing, what&apos;s declining, and where to focus next.</p>
                  </div>
                  <div className="border-t border-white/10 pt-4">
                    <p className="text-xs font-bold text-[#C8FF00] uppercase tracking-wide mb-1">&gt; AI Insights</p>
                    <p className="text-white/80 text-sm font-semibold">JABA surfaces patterns and recommendations automatically.</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <section className="relative z-10 py-20 px-6 bg-black">
          <div className="max-w-5xl mx-auto rounded-2xl border border-white/10 bg-white/[0.03] p-8 md:p-12 backdrop-blur-sm">
